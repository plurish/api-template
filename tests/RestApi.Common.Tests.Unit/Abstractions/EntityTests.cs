...
using RestApi.Common.Tests.Unit.Abstractions.Utilities;
using Common.UnitTests.Abstractions.Utilities;
using FluentAssertions;
using static RestApi.Common.Tests.Unit.Abstractions.Utilities.Fakes.ValueObject;
using static Common.UnitTests.Abstractions.Utilities.Fakes.Entity;

namespace RestApi.Common.Tests.Unit.Abstractions;
